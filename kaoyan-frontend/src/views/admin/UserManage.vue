<template>
    <div class="user-manage-container">
        <el-card shadow="never" class="table-card">
            ...
            <el-form :inline="true" :model="searchForm" class="search-form">
                <el-form-item label="角色">
                    <el-select v-model="searchForm.role" placeholder="请选择角色" clearable style="width: 150px" @change="loadData">
        ...
        <el-drawer
            ...
            :title="`学习进度 - ${currentUser?.nickname || currentUser?.username}`"
            size="50%"
            destroy-on-close
        >
            <div v-loading="statsLoading" class="drawer-content">
                ...
                <el-card shadow="never" class="user-info-card">
                    ...
                    <el-descriptions :column="2" border>
                        ...
                        <el-descriptions-item label="目标院校">
                            <el-tag type="success" v-if="currentUser?.targetSchool">{{ currentUser.targetSchool }}</el-tag>
                ...
                <el-card shadow="never" class="overall-stats-card">
                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="8">
                            <div class="stat-item">
                                <div class="stat-value">{{ studyStats?.overallStats?.overallAccuracy?.toFixed(2) || 0 }}%</div>
